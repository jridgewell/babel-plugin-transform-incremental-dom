...
var iDOM = _interopRequireWildcard(require("idom-wrapper"));
...
var _li$wrapper = function _li$wrapper() {
  (0, iDOM.elementOpen)("li");
  (0, iDOM.text)("x.text");
  return (0, iDOM.elementClose)("li");
};
...
iDOM.patch(container, function () {
  (0, iDOM.elementOpen)("div");

  _renderArbitrary(todoItems);

  return (0, iDOM.elementClose)("div");
});